...
{
    public abstract class STR_DefaultEngineConfig : STR_ApplicationConfig
    {
        protected static Graphics mogGraphics = null;

        protected static Process mopProcess = null;

        public STR_DefaultEngineConfig ( STR_ConfigPackage strcpConfigPackage ) : base ( strcpConfigPackage )
        {
        }

        protected STR_DefaultEngineConfig ( string sWindowTitle , int iWidth , int iHeight ) : base ( sWindowTitle , iWidth , iHeight )
        {
        }
